...
const ForthBlog = () =>
{
  ...
  return (
    <>
      <div className={`${mainTopics} blog-four`} id="forthBlog">
        <h2 className="py-4 px-3 my-2 d-flex align-items-center mx-4 rounded">الحياة اليومية</h2>
